#!/bin/bash
#
# This script builds mfc-cli with dotnet 2.0, and runs the tests.
#
CONTAINER_NAME="mfc-cli-ci"
...
# Build the Docker image (includes building the current mfc-cli code)
