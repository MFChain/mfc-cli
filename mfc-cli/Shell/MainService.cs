using Mfc.Consensus;
using Mfc.Core;
using Mfc.Implementations.Blockchains.LevelDB;
using Mfc.Implementations.Wallets.EntityFramework;
using Mfc.Implementations.Wallets.NEP6;
using Mfc.IO;
using Mfc.IO.Json;
using Mfc.Network;
using Mfc.Network.Payloads;
using Mfc.Network.RPC;
using Mfc.Services;
...
using ECCurve = Mfc.Cryptography.ECC.ECCurve;
...
namespace Mfc.Shell
{
    internal class MainService : ConsoleServiceBase
    {
        ...
        protected override string Prompt => "mfc";
        public override string ServiceName => "MFC-CLI";
