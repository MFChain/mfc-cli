...
- New smart contract APIs: `Mfc.Enumerator.*`.
- New smart contract API: `System.Blockchain.GetTransactionHeight`.
- New smart contract API: `System.Storage.GetReadOnlyContext` and `Mfc.StorageContext.AsReadOnly`.

### Changed
- Support for MfcContract Standary Namespace.
...
- Daemonizing the mfc process.
- Support for Mfc Plugins System.
- New smart contract API: `Mfc.Contract.IsPayable`.
...
### Fixed
- Fix the issue of `Mfc.Storage.Find`.(smart contract)
...
- New smart contract APIs: `Mfc.Iterator.*`, `Mfc.Storage.Find`.
- New smart contract APIs: `Mfc.Runtime.Serialize`, `Mfc.Runtime.Deserialize`.
- New smart contract API: `Mfc.TransactionInvocation.GetScript`.
...
### Removed
- Remove `Mfc.Account.SetVotes` and `Mfc.Validator.Register`.(smart contract)

## [2.5.2] - 2017-12-14
### Added
- New smart contract API: `Mfc.Runtime.GetTime`.
...
- New smart contract APIs: `Mfc.Transaction.GetUnspentCoins`, `Mfc.Header.GetIndex`.
...
### Fixed
- Fix the issue of `Mfc.Runtime.CheckWitness`.(smart contract)
